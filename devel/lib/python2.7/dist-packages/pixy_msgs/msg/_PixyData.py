...
"""autogenerated by genpy from pixy_msgs/PixyData.msg. Do not edit."""
import codecs
import sys
...
import pixy_msgs.msg
import sensor_msgs.msg
import std_msgs.msg

class PixyData(genpy.Message):
  _md5sum = "ef2e0586b5303fe53a804dd89384f7c8"
  _type = "pixy_msgs/PixyData"
...
"""
  ...
  _slot_types = ['std_msgs/Header','pixy_msgs/PixyBlock[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.angle,) = _get_struct_f().unpack(str[start:end])
