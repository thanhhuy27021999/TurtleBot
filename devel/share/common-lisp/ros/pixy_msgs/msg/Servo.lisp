...
(cl:defmethod cl:initialize-instance :after ((m <Servo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pixy_msgs-msg:<Servo> is deprecated: use pixy_msgs-msg:Servo instead.")))

(cl:ensure-generic-function 'channel-val :lambda-list '(m))
(cl:defmethod channel-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pixy_msgs-msg:channel-val is deprecated.  Use pixy_msgs-msg:channel instead.")
  (channel m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pixy_msgs-msg:position-val is deprecated.  Use pixy_msgs-msg:position instead.")
  (position m))
