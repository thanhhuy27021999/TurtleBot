...
(cl:defclass <PixyData> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (blocks
    :reader blocks
    :initarg :blocks
    :type (cl:vector pixy_msgs-msg:PixyBlock)
   :initform (cl:make-array 0 :element-type 'pixy_msgs-msg:PixyBlock :initial-element (cl:make-instance 'pixy_msgs-msg:PixyBlock))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PixyData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PixyData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pixy_msgs-msg:<PixyData> is deprecated: use pixy_msgs-msg:PixyData instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PixyData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pixy_msgs-msg:header-val is deprecated.  Use pixy_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'blocks-val :lambda-list '(m))
(cl:defmethod blocks-val ((m <PixyData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pixy_msgs-msg:blocks-val is deprecated.  Use pixy_msgs-msg:blocks instead.")
  (blocks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PixyData>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'blocks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pixy_msgs-msg:PixyBlock))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PixyData>)))
  ...
  "ef2e0586b5303fe53a804dd89384f7c8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PixyData)))
  "Returns md5sum for a message object of type 'PixyData"
  "ef2e0586b5303fe53a804dd89384f7c8")
